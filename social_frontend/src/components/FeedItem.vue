    ...
    <div>
        ...
        <div class="my-6 flex justify-between">
            <div class="flex space-x-6 items-center">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <RouterLink :to="{ name: 'postDetails', params: { id: post.id } }" class="text-gray-500 text-xs">
        ...
        <div v-if="showExtraDiv">
            <div class="flex space-x-6 items-center">
                ...
                <div class="flex items-center space-x-2" @click="report_post">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <span class="text-blue-500 text-xs">Report </span>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if (response.data.message == "Like created!!") {
                        ...
                        this.toastStore.showToast(5000, "This post is alredy liked by You!!", "bg-emerald-300");
                    }
                })
                .catch((error) => {
        ...
        toggleModles() {
            console.log("toggleModles");
            this.showExtraDiv = !this.showExtraDiv;
        },
        deletePost() {
            axios
                .delete(`/api/posts/delete-post/${this.post.id}/`)
                .then((response) => {
        ...
        report_post() {
            axios
                .post(`/api/posts/report-post/${this.post.id}/`)
                .then((response) => {
                    // console.log(response.data);
                    this.toastStore.showToast(5000, response.data.message, "bg-emerald-300");
                })

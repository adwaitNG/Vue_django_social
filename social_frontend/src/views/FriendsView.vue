<template>
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
            <div class="p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-3 gap-4" v-if="friends.length">
            ...
            <div class="p-4 bg-white border border-gray-200" v-if="friendshipRequest.length">
                <hr />
                ...
                >
                    ...
                    <div class="mt-6 flex space-x-8 justify-around">
                        ...
                        <p class="text-xs text-gray-500">{{ friendshipRequest.created_by.post_count }} posts</p>
                    </div>
                    <div class="mt-6 space-x-5">
                        ...
                        <button
                            ...
                            @click="handelRequest('rejected', friendshipRequest.created_by.id)"
                        >
                            Reject
                        </button>
                    </div>

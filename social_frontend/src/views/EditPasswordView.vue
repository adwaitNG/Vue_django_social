    ...
    <div class="max-w-7xl mx-auto grid grid-cols-2 gap-4">
        <div class="main-left">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                ...
                <p class="mb-6 text-gray-500">Change you Password ?</p>
            </div>
        </div>
    ...
    methods: {
        submitForm() {
            ...
            if (this.errors.length === 0) {
                ...
                axios
                    .post("/api/edit-password/", formData, { headers: { "Content-Type": "multipart/form-data" } })
                    .then((response) => {
                        if (response.data.message === "success") {
                            this.toastStore.showToast(5000, "The Password is saved", "bg-emerald-500");
                            ...
                            this.toastStore.showToast(
                                5000,
                                `Not able to change the password, please try again.`,
                                "bg-yellow-300"
                            );
                        }
                    })

        ...
        <div class="main-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
                ...
                <div class="mt-6">
                    ...
                    <button
                        v-if="userStore.user.id === user.id"
                        class="inline-block py-4 px-3 bg-yellow-600 test-xs text-white rounded-lg"
                        @click="logout"
                    >
                        Logout
                    </button>
                ...
                <div class="bg-white border border-gray-200 rounded-lg" v-if="userStore.user.id === user.id">
                    <form v-on:submit.prevent="submitPost" method="post">
                        ...
                        <div class="p-4 border-t border-gray-100 flex justify-between">
                            <a class="inline-block py-4 px-6 bg-gray-600 text-white rounded-lg">Attach image</a>
